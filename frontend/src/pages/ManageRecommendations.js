...
function ManageRecommendations() {
  ...
  const fetchMovies = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://flask-9sty.onrender.com/api/movies");
      const data = await res.json();
      setMovies(data);
    } catch (err) {
      console.error(err);
  ...
  const fetchBooks = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://flask-9sty.onrender.com/api/books");
      const data = await res.json();
      setBooks(Array.isArray(data) ? data : []);
    } catch (err) {
      console.error(err);
  ...
  const fetchSongs = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://flask-9sty.onrender.com/api/songs");
      const data = await res.json();
      setSongs(Array.isArray(data) ? data : []);
    } catch (err) {
      console.error(err);
  ...
  const updateMovie = async (id, updatedMovie) => {
    try {
      await fetch(`https://flask-9sty.onrender.com/api/movies/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(updatedMovie),
      });
  ...
  const deleteMovie = async (id) => {
  try {
    const res = await fetch(`https://flask-9sty.onrender.com/api/movies/${id}`, { method: "DELETE" });
    const data = await res.json();
    if (res.ok) {
                  ...
                  <td style={styles.td}>
                    <button
                      ...
                      onClick={async () => {
                        ...
                        await fetch(`https://flask-9sty.onrender.com/api/books/${book.index}`, { method: "DELETE" });
                  ...
                  <td style={styles.td}>
                    <button
                      ...
                      onClick={async () => {
                        ...
                        await fetch(`https://flask-9sty.onrender.com/api/songs/${song.index}`, { method: "DELETE" });
